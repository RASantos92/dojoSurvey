		...
		<form action="/survey/validate" method="post">
		  ...
		  <div class="form-group row">
		    <label for="dojo location" class="col-sm-2 col-form-label">Dojo Location:</label>
		   	<div class="col-sm-8 mx-auto">
	   			<select name="location" id="location" class="custom-select col">
				  <option value="Didnt Choose">--Dojo Location--</option>
	  	...
	  	<div class="form-group row">
	    	<label for="favorite language" class="col-sm-2 col-form-label">Favorite Language:</label>
	   		<div  class="col-sm-8 mx-auto">
			    <select name="lang" id="lang" class="custom-select col">
				  <option value="Didnt select">--Favorite Computer Language--</option>
